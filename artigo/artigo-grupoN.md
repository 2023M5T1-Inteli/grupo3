...
O artigo "Controlled Flight into Terrain: How the Airlines and the Federal Aviation Administration are Addressing the Problem" de Roger C. Matteson discute a questão de voos controlados contra o terreno (CFIT, na sigla em inglês), que ocorrem quando uma aeronave em pleno voo colide com o solo ou outras obstruções devido a erros humanos ou falhas técnicas. O autor apresenta estatísticas sobre o número de acidentes desse tipo e destaca a importância de se tomar medidas para prevenir futuras ocorrências. O autor também enfatiza a importância de tecnologias avançadas e treinamento adequado dos pilotos para garantir a segurança das operações aéreas.

O artigo "CFIT prevention using synthetic vision" de Arthur III, Jarvis J. et al. destaca a gravidade dos acidentes CFIT e a importância das iniciativas da FAA e das companhias aéreas para prevenir futuras ocorrências. O autor enfatiza a importância de tecnologias avançadas e treinamento adequado dos pilotos para garantir a segurança das operações aéreas. Como limitações do estudo, podemos citar, por exemplo, a concentração exclusiva em uma abordagem específica para prevenir o voo controlado para o solo (CFIT) usando visão sintética, sem considerar outros fatores que podem contribuir para o problema. 

O artigo "Optimal Aircraft Terrain-Following Analysis and Trajectory Generation" de Ping Lu e Bion L. Pierson, publicado no Journal of Guidance, Control, and Dynamics, apresenta uma metodologia para gerar trajetórias ótimas para voos de seguimento de terreno em aviões militares de asa fixa. O artigo descreve a modelagem matemática do problema, considerando a dinâmica do avião e as limitações de segurança, bem como o terreno e as características ambientais. O algoritmo proposto para gerar as trajetórias é baseado em programação dinâmica, com o objetivo de minimizar o consumo de combustível, atender aos requisitos de segurança e manter a aeronave a uma altitude segura em relação ao terreno. O artigo apresenta resultados de simulações para validar a metodologia proposta e demonstra que as trajetórias geradas são efetivas e seguras. O trabalho contribui para a área de navegação de aviões militares e pode ter aplicações em outras áreas, como aeronaves civis e sistemas de controle de tráfego aéreo. Um dos pontos positivos do artigo é que o estudo apresenta resultados de simulações que demonstram a efetividade e segurança das trajetórias geradas pela metodologia proposta, o que fornece evidências empíricas da viabilidade da abordagem.

O trabalho LAPP de Tiffany Rae é uma tese de doutorado do Massachusetts Institute of Technology (MIT) que trata do uso do controle preditivo de modelos para realizar o seguimento em tempo real de terrenos em voos de baixa altitude. Em voos de baixa altitude, é importante manter uma distância segura em relação ao terreno para evitar colisões. Para isso, é necessário ter um sistema de navegação que possa detectar e seguir continuamente o relevo do terreno. A técnica proposta por Tiffany Rae envolve a criação de um modelo matemático do comportamento da aeronave em relação ao terreno e o uso de um controlador preditivo de modelo para ajustar continuamente o voo com base em leituras do terreno. Esse modelo considera os efeitos da dinâmica do vento, da altitude, da velocidade, da aceleração e do ângulo de inclinação da aeronave. Em suma, o artigo LAPP de Tiffany Rae apresenta uma técnica inovadora e eficaz de controle de voo para voos de baixa altitude, que permite seguir com segurança o terreno em tempo real, evitando colisões e melhorando a precisão da navegação.
